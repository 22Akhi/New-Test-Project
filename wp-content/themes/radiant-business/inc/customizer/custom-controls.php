<?php
/**
 * Radiant Business Customizer Custom Controls
 *
 */
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	 class Radiant_Business_Image_Checkbox_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'radiant_business_image_checkbox';
	 ...
	 */
	 class Radiant_Business_Text_Radio_Button_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'radiant_business_text_radio_button';
	 ...
	 */
	class Radiant_Business_Image_Radio_Button_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'radiant_business_image_radio_button';
	 ...
	 */
	class Radiant_Business_Simple_Notice_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'radiant_business_simple_notice';
	 ...
	 */
	class Radiant_Business_Slider_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'radiant_business_slider_control';
	 ...
	 */
	class Radiant_Business_Toggle_Switch_Custom_control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'radiant_business_toggle_switch';
	 ...
	 */
	class Radiant_Business_Sortable_Repeater_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'radiant_business_sortable_repeater';
		...
		public function __construct( $manager, $id, $args = array(), $options = array() ) {
			...
			$this->button_labels = wp_parse_args( $this->button_labels,
				array(
					'add' => esc_html__( 'Add', 'radiant-business' ),
				)
			);
		}
	 ...
	 */
	class Radiant_Business_Dropdown_Select2_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'radiant_business_dropdown_select2';
	 ...
	 */
	class Radiant_Business_Dropdown_Posts_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'radiant_business_dropdown_posts';
		...
		public function __construct( $manager, $id, $args = array(), $options = array() ) {
			...
			// Get our Posts
			$this->posts = Radiant_Business_Customizer_Utilities::get_posts_as_array( $this->input_attrs );
		}
	 ...
	 */
	class Radiant_Business_TinyMCE_Custom_control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'radiant_business_tinymce_editor';
		...
		public function to_json() {
			parent::to_json();
			$this->json['radiantBusinesstinymcetoolbar1'] = isset( $this->input_attrs['toolbar1'] ) ? esc_attr( $this->input_attrs['toolbar1'] ) : 'bold italic bullist numlist alignleft aligncenter alignright link';
			$this->json['radiantBusinesstinymcetoolbar2'] = isset( $this->input_attrs['toolbar2'] ) ? esc_attr( $this->input_attrs['toolbar2'] ) : '';
			$this->json['radiantBusinessmediabuttons'] = isset( $this->input_attrs['mediaButtons'] ) && ( $this->input_attrs['mediaButtons'] === true ) ? true : false;
		}
	 ...
	 */
	class Radiant_Business_Note_Control extends WP_Customize_Control {
		public $type = 'radiant_business_description';
	 ...
	 *
	 */
	class Radiant_Business_Upsell_Section extends WP_Customize_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'radinat-business-upsell';
	 ...
	 */
	if ( ! function_exists( 'radiant_business_url_sanitization' ) ) {
		function radiant_business_url_sanitization( $input ) {
	 ...
	 */
	if ( ! function_exists( 'radiant_business_switch_sanitization' ) ) {
		function radiant_business_switch_sanitization( $input ) {
			return $input;
			if ( true === $input ) {
				return 1;
			} else {
	 ...
	 * @return integer	Sanitized value
	 */
	if ( ! function_exists( 'radiant_business_radio_sanitization' ) ) {
		function radiant_business_radio_sanitization( $input, $setting ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'radiant_business_text_sanitization' ) ) {
		function radiant_business_text_sanitization( $input ) {
	 ...
	 */
	function radiant_business_sanitize_select( $input, $setting ) {
	 ...
	 */
	function radiant_business_sanitize_map_code( $input ) {
		// allow iframe.
