/* global radiantBusinessScreenReaderText */
/**
...
(function($) {
    ...
    function initMainNavigation(container) {
        ...
        var dropdownToggle = $('<button />', {
            ...
            .append(radiantBusinessScreenReaderText.icon)
            .append($('<span />', {
                'class': 'screen-reader-text',
                text: radiantBusinessScreenReaderText.expand
            }));
        ...
        container.find('.current-menu-ancestor > button')
            ...
            .text(radiantBusinessScreenReaderText.collapse);
        ...
        container.find('.dropdown-toggle').on('click', function(e) {
            ...
            // jscs:enable
            screenReaderSpan.text(screenReaderSpan.text() === radiantBusinessScreenReaderText.expand ? radiantBusinessScreenReaderText.collapse : radiantBusinessScreenReaderText.expand);
        });
    }
    ...
    (function() {
        ...
        menuToggle.on('click.radiantBusiness', function() {
    ...
    (function() {
        ...
        function toggleFocusClassTouchScreen() {
            if (window.innerWidth >= 910) {
                $(document.body).on('touchstart.radiantBusiness', function(e) {
                    if (!$(e.target).closest('.main-navigation li').length) {
                        $('.main-navigation li').removeClass('focus');
                    }
                });
                siteNavigation.find('.menu-item-has-children > a, .page_item_has_children > a').on('touchstart.radiantBusiness', function(e) {
                ...
                siteNavigation.find('.menu-item-has-children > a').off('touchstart.radiantBusiness');
            }
        }

        if ('ontouchstart' in window) {
            $(window).on('resize.radiantBusiness', toggleFocusClassTouchScreen);
            toggleFocusClassTouchScreen();
        }

        siteNavigation.find('a').on('focus.radiantBusiness blur.radiantBusiness', function() {
    ...
    (function() {
        ...
        menuToggleMobile.on('click.radiantBusiness', function() {
    ...
    (function() {
        ...
        function toggleFocusClassTouchScreen() {
            if (window.innerWidth >= 910) {
                ...
                siteNavigationMobile.find('.menu-item-has-children > a, .page_item_has_children > a').on('touchstart.radiantBusiness', function(e) {
                    var el = $(this).parent('li');
                ...
                siteNavigationMobile.find('.menu-item-has-children > a').off('touchstart.radiantBusiness');
            }
        }
        ...
        siteNavigationMobile.find('a').on('focus.radiantBusiness blur.radiantBusiness', function() {
            $(this).parents('.menu-item, .page_item').toggleClass('focus');
        });
    })();
    ...
    $(document).ready(function() {
        $(window).on('load.radiantBusiness resize.radiantBusiness', function() {
            if ( window.innerWidth < 910 ) {
                if ( $('#site-primary-navigation-mobile').length ) {
                    ...
                    $( main_nav_mobile_focusable[main_nav_mobile_focusable.length - 1] ).on('focusout', function(e) {
                ...
                if ( $('#site-top-header-mobile-container').length ) {
                    ...
                    $( top_bar_focusable[top_bar_focusable.length - 1] ).on('focusout', function(e) {
                        $('#header-top-toggle').focus();
                    });
                }
            }

            $('.search-container .search-submit').on('focusout', function(e) {
                var $elem = $(this);

                $elem.parents().siblings('.search-toggle').focus();
            });
        });
    });
})(jQuery);
